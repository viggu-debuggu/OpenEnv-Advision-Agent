...
class AdVisionEnv(Environment[AdVisionAction, AdVisionObservation, dict]):
    def __init__(self):
        super().__init__()
    ...
    def step(self, action: AdVisionAction) -> Tuple[AdVisionObservation, float, bool, dict]:
        # Map OpenEnv Action to Internal Gym Action
